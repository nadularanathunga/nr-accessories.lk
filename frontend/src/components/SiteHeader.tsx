        ...
        <div className="mx-auto flex max-w-[1280px] items-center gap-3 px-4 py-3 sm:gap-4 lg:px-6 lg:py-4">
          ...
          <div className="ml-auto flex items-center gap-1 sm:gap-3">
            ...
            {user?.role === 'admin' && (
              <Link
                to="/admin/products"
                className="hidden items-center gap-2 rounded-xl px-2 py-2 text-[13px] font-medium text-brand-700 transition-colors duration-150 ease-soft hover:bg-brand-50 lg:flex"
              >
                Admin Panel
              </Link>
            )}
